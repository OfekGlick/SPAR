...
from base_envs.robosuite.models.objects import CompositeObject
from base_envs.robosuite.utils.mjcf_utils import BLUE, GREEN, RED, CustomMaterial, add_to_dict
...
class HookFrame(CompositeObject):
    ...
    def _get_geom_attrs(self):
        ...
        if self.tip_size is not None:
            from base_envs.robosuite.models.objects import ConeObject
