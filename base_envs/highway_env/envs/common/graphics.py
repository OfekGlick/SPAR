...
from base_envs.highway_env.envs.common.action import (
    ActionType,
    ContinuousAction,
    DiscreteMetaAction,
)
from base_envs.highway_env.road.graphics import RoadGraphics, WorldSurface
from base_envs.highway_env.vehicle.graphics import VehicleGraphics


if TYPE_CHECKING:
    from base_envs.highway_env.envs import AbstractEnv
    from base_envs.highway_env.envs.common.abstract import Action
...
class ObservationGraphics:
    ...
    def display(cls, obs, sim_surface):
        from base_envs.highway_env.envs.common.observation import LidarObservation
