...
from base_envs.highway_env.road.lane import AbstractLane, LineType, StraightLane, lane_from_config
from base_envs.highway_env.vehicle.objects import Landmark


if TYPE_CHECKING:
    from base_envs.highway_env.vehicle import kinematics, objects
