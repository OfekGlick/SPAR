...
class AlgoWrapper:
    ...
    def _init_config(self) -> Config:
        ...
        exp_name = f'{self.algo}-{self.env_id.split("budget-aware-")[1]}{use_all_obs}{sd_reg_str}{random_mask_str}-{budget_str}-{reward_norm_str}-{cfgs["train_cfgs"]["total_steps"]}_steps-{obs_modality_norm}'
